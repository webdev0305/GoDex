-.273,1.2-.379,1.6a7.119,7.119,0,0,1-1.916,3.573,4.69,4.69,0,0,1-3.313,1.217,2.7,2.7,0,0,1-2.615-1.217,5.671,5.671,0,0,1-.26-3.573c.053-.4.153-.931.3-1.6s.273-1.2.38-1.6a7.216,7.216,0,0,1,1.916-3.551,4.594,4.594,0,0,1,3.273-1.238,2.73,2.73,0,0,1,2.634,1.238A5.524,5.524,0,0,1-658.23-2925.092Z", transform:"translate(773.626 2975.723)", fill:"#2adbad" }),
        React__default.createElement("path", { d: "M-647.438-2941.756l-7.889-7.889-2.346,2.348,2.616,2.616h-35.21a17.118,17.118,0,0,0-5.86,1.3,13.65,13.65,0,0,0-5.2,3.811,14.389,14.389,0,0,0-2.927,6.023q-.464,1.852-.906,3.917t-.779,3.874a11.5,11.5,0,0,0,.358,6.171,7.238,7.238,0,0,0,3.517,3.875,13.921,13.921,0,0,0,6.486,1.326,18.09,18.09,0,0,0,7.14-1.369,14.032,14.032,0,0,0,5.37-3.938,13.567,13.567,0,0,0,2.864-6.191l1.011-4.591a.912.912,0,0,0-.147-.758.832.832,0,0,0-.7-.294h-10.319a1.253,1.253,0,0,0-.821.294,1.236,1.236,0,0,0-.442.758l-.59,2.7a.9.9,0,0,0,.147.736.762.762,0,0,0,.653.316h4.591l-.211,1.053a7.577,7.577,0,0,1-1.495,3.328,6.45,6.45,0,0,1-2.569,1.916,8.552,8.552,0,0,1-3.265.611,4.967,4.967,0,0,1-3.9-1.432q-1.285-1.432-.737-4.718.337-1.852.737-3.707t.864-3.664a7.683,7.683,0,0,1,2.611-4.549,7.227,7.227,0,0,1,4.465-1.39h.047v.015H-654.6l-3.072,3.071,2.346,2.347,7.889-7.889-.011-.01Z", transform:"translate(777.187 2977.392)", fill:"#2adbad" }),
    ));
};

var BarsIcon = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 -8 32 26" }, props),
        React__default.createElement("path", { d: "M2,2H28.161", stroke:"#2adbad", strokeLinecap:"round", strokeWidth:"3"}),
        React__default.createElement("path", { d: "M2,9H22.529", stroke:"#2adbad", strokeLinecap:"round", strokeWidth:"3"}),
        React__default.createElement("path", { d: "M2,16H16.9", stroke:"#2adbad", strokeLinecap:"round", strokeWidth:"3"}),
    ));
};

var Logo$2 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "71 27 178 61" }, props),
        React__default.createElement("path", { d: "M-602.794-2912.862a10.717,10.717,0,0,1-5.328-1.2,6.245,6.245,0,0,1-2.927-3.559,11.768,11.768,0,0,1-.211-5.771q.084-.337.19-.906a5.426,5.426,0,0,1,.232-.9,15.453,15.453,0,0,1,2.633-5.582,11.885,11.885,0,0,1,4.423-3.579,13.4,13.4,0,0,1,5.791-1.243,9.47,9.47,0,0,1,5.581,1.453,6.906,6.906,0,0,1,2.717,3.959,12.4,12.4,0,0,1,0,5.749l-.168.969a1.192,1.192,0,0,1-.464.716,1.337,1.337,0,0,1-.842.295H-604.9a.851.851,0,0,1-.021.147.784.784,0,0,1-.063.19,7.217,7.217,0,0,0,0,2.463,3.016,3.016,0,0,0,.99,1.791,3.011,3.011,0,0,0,2.043.673,4.868,4.868,0,0,0,1.769
,2.869,0,0,0,2.09.788,3.9,3.9,0,0,0,1.628-.273,3.344,3.344,0,0,0,1.039-.777,1.123,1.123,0,0,1,.3-.231.89.89,0,0,1,.368-.063h.63a.57.57,0,0,1,.42.168.479.479,0,0,1,.147.4,2.3,2.3,0,0,1-.619,1.166A4.116,4.116,0,0,1,93.376-.2a6.263,6.263,0,0,1-2.384.41A4.622,4.622,0,0,1,88.6-.41a4.559,4.559,0,0,1-1.67-1.712,6.043,6.043,0,0,1-.745-2.457q-.042-.63-.042-.966t.042-.966a5.635,5.635,0,0,1,.745-2.352,4.6,4.6,0,0,1,1.659-1.659A4.668,4.668,0,0,1,90.993-11.13Zm2.961,4.683V-6.51a2.689,2.689,0,0,0-.809-2.048,3,3,0,0,0-2.153-.766,2.956,2.956,0,0,0-2.068.777,2.694,2.694,0,0,0-.871,2.037v.063Z", transform:"translate(151.497 83)", fill:"#1ebf8d" }),
    ));
};
...
var Icon$1e = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 25 25" }, props),
        ...
        React__default.createElement("path", { d: "M19.8989 24.1416L11.8536 16.0962C11.6583 15.901 11.6583 15.5844 11.8536 15.3891L15.3891 11.8536C15.5843 11.6583 15.9009 11.6583 16.0962 11.8536L24.1416 19.899C24.4325 20.1899 24.2671 20.6882 23.8599 20.7473L21.5113 21.0884C21.2923 21.1202 21.1202 21.2923 21.0884 21.5114L20.7473 23.8599C20.6882 24.2671 20.1899 24.4326 19.8989 24.1416Z", fill: "#1EBF8D" }),
        React__default.createElement("path", { d: "M5.19774 24.1416L13.2431 16.0962C13.4384 15.901 13.4384 15.5844 13.2431 15.3891L9.70759 11.8536C9.51233 11.6583 9.19575 11.6583 9.00049 11.8536L0.955098 19.899C0.664132 20.1899 0.829575 20.6882 1.23679 20.7473L3.58535 21.0884C3.80441 21.1202 3.97648 21.2923 4.0083 21.5114L4.34938 23.8599C4.40852 24.2671 4.90677 24.4326 5.19774 24.1416Z", fill: "#1EBF8D" }),
        ...
        React__default.createElement("ellipse", { rx: "6.64749", ry: "6.39038", transform: "matrix(0.882297 -0.470693 0.52989 0.848067 12.4778 12.6875)", fill: "#1EBF8D" }),
...
var Icon$13 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "71 27 60 40" }, props),
    React__default.createElement("path", { d: "M-655.5-2933.173a11.047,11.047,0,0,0-5.169-1.1,13.5,13.5,0,0,0-5.667,1.1,10.053,10.053,0,0,0-3.912,3.113,13.492,13.492,0,0,0-2.235,4.77c-.16.506-.314,1.1-.459,1.776a16.183,16.183,0,0,0-.3,1.816,8.424,8.424,0,0,0,.439,4.75,6.29,6.29,0,0,0,2.974,3.132,11.132,11.132,0,0,0,5.209,1.1,13.814,13.814,0,0,0,5.787-1.1,9.649,9.649,0,0,0,3.872-3.132,14.184,14.184,0,0,0,2.195-4.75q.2-.8.419-1.816t.34-1.776a7.911,7.911,0,0,0-.459-4.77A6.622,6.622,0,0,0-655.5-2933.173Zm-2.734,8.082q-.08.6-.3,1.6c-.146.665-.273,1.2-.379,1.6a7.119,7.119,0,0,1-1.916,3.573,4.69,4.69,0,0,1-3.313,1.217,2.7,2.7,0,0,1-2.615-1.217,5.671,5.671,0,0,1-.26-3.573c.053-.4.153-.931.3-1.6s.273-1.2.38-1.6a7.216,7.216,0,0,1,1.916-3.551,4.594,4.594,0,0,1,3.273-1.238,2.73,2.73,0,0,1,2.634,1.238A5.524,5.524,0,0,1-658.23-2925.092Z", transform:"translate(773.626 2975.723)", fill:"#2adbad" }),
    React__default.createElement("path", { d: "M-647.438-2941.756l-7.889-7.889-2.346,2.348,2.616,2.616h-35.21a17.118,17.118,0,0,0-5.86,1.3,13.65,13.65,0,0,0-5.2,3.811,14.389,14.389,0,0,0-2.927,6.023q-.464,1.852-.906,3.917t-.779,3.874a11.5,11.5,0,0,0,.358,6.171,7.238,7.238,0,0,0,3.517,3.875,13.921,13.921,0,0,0,6.486,1.326,18.09,18.09,0,0,0,7.14-1.369,14.032,14.032,0,0,0,5.37-3.938,13.567,13.567,0,0,0,2.864-6.191l1.011-4.591a.912.912,0,0,0-.147-.758.832.832,0,0,0-.7-.294h-10.319a1.253,1.253,0,0,0-.821.294,1.236,1.236,0,0,0-.442.758l-.59,2.7a.9.9,0,0,0,.147.736.762.762,0,0,0,.653.316h4.591l-.211,1.053a7.577,7.577,0,0,1-1.495,3.328,6.45,6.45,0,0,1-2.569,1.916,8.552,8.552,0,0,1-3.265.611,4.967,4.967,0,0,1-3.9-1.432q-1.285-1.432-.737-4.718.337-1.852.737-3.707t.864-3.664a7.683,7.683,0,0,1,2.611-4.549,7.227,7.227,0,0,1,4.465-1.39h.047v.015H-654.6l-3.072,3.071,2.346,2.347,7.889-7.889-.011-.01Z", transform:"translate(777.187 2977.392)", fill:"#2adbad" }),
    ));
};
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        ...
        React__default.createElement("defs", null,
            React__default.createElement("linearGradient", { id: "paint0_linear_won", x1: "31.2114", y1: "29.9293", x2: "38.4169", y2: "56.8207", gradientUnits: "userSpaceOnUse" },
                ...
                React__default.createElement("stop", { offset: "1", stopColor: "#1EBF8D" })),
...
var Icon$E = function (props) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 25 25" }, props),
        React__default.createElement("g", { clipPath: "url(#" + id + ")" },
            React__default.createElement("path", { d: "M15.9617 4.03476C16.5597 2.82143 15.6818 1.40061 14.2254 1.22477C13.0389 1.08149 11.9708 1.84428 11.8399 2.9285L11.3896 6.65764C11.2976 7.41951 11.899 8.11875 12.7328 8.21943C13.3889 8.29864 14.0166 7.98162 14.286 7.435L15.9617 4.03476Z", fill: "#1EBF8D" }),
            React__default.createElement("path", { d: "M6.27612 5.16903C5.36287 4.17118 5.80868 2.56162 7.15782 1.98574C8.25706 1.51653 9.49573 1.95041 9.92446 2.95482L11.3991 6.40949C11.7004 7.11529 11.3184 7.95473 10.546 8.28444C9.93817 8.54388 9.24684 8.41494 8.83541 7.9654L6.27612 5.16903Z", fill: "#1EBF8D" }),
            React__default.createElement("path", { d: "M17.0349 9.11691C17.3916 11.6186 15.2219 13.6784 12.2437 14.1031C9.26546 14.5278 6.60649 13.1564 6.24978 10.6548C5.89307 8.15311 8.06278 6.09324 11.041 5.66857C14.0192 5.24391 16.6782 6.61525 17.0349 9.11691Z", fill: "#1EBF8D" }),
...
var Icon$s = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 35 35" }, props),
        React.createElement("path", { d: "M17.5,35A17.5,17.5,0,0,1,5.126,5.126,17.5,17.5,0,1,1,29.874,29.874,17.386,17.386,0,0,1,17.5,35ZM7.887,23.54h0a11.219,11.219,0,0,0,17.269-9.452c0-.17,0-.342-.011-.51a7.984,7.984,0,0,0,1.968-2.042,7.884,7.884,0,0,1-2.266.621,3.943,3.943,0,0,0,1.734-2.182,7.863,7.863,0,0,1-2.5.957,3.948,3.948,0,0,0-6.721,3.6,11.23,11.23,0,0,1-8.13-4.121,3.948,3.948,0,0,0,1.22,5.267,3.948,3.948,0,0,1-1.786-.494c0,.017,0,.033,0,.05A3.955,3.955,0,0,0,11.823,19.1a3.941,3.941,0,0,1-1.781.067,3.945,3.945,0,0,0,3.685,2.74,7.871,7.871,0,0,1-4.9,1.688A8.159,8.159,0,0,1,7.887,23.54Z" })));
};
...
var MenuHomeIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 27.856 27.856" }, props),
    React.createElement("path", { d: "M18.11,22.779h-13A3.707,3.707,0,0,1,1.583,19.8L.039,10.557A3.906,3.906,0,0,1,1.327,7.18L9.37.738A3.745,3.745,0,0,1,13.85.75L21.894,7.18a3.968,3.968,0,0,1,1.288,3.377L21.639,19.8A3.713,3.713,0,0,1,18.11,22.779Zm-6.5-13.127a2.9,2.9,0,1,0,2.9,2.9A2.905,2.905,0,0,0,11.611,9.652Z", transform:"translate(2.317 2.535)", fill:"#53f3c3" }))); };
var MenuExchangeIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 22 22.011" }, props),
    React.createElement("path", { d: "M15.606,22.011H6.395c-4,0-6.395-2.394-6.395-6.4V6.395C0,2.391,2.391,0,6.395,0h9.223a6.455,6.455,0,0,1,4.7,1.7A6.444,6.444,0,0,1,22,6.395v9.223C22,19.621,19.61,22.011,15.606,22.011ZM5.5,12.117a.827.827,0,0,0-.826.826.837.837,0,0,0,.826.825h9.014l-1.838,1.838a.825.825,0,1,0,1.167,1.166l3.247-3.246a.863.863,0,0,0,.175-.264.83.83,0,0,0,.011-.627.859.859,0,0,0-.451-.452.835.835,0,0,0-.319-.066ZM8.749,5a.821.821,0,0,0-.584.239L4.92,8.486a1.111,1.111,0,0,0-.187.263.774.774,0,0,0,0,.628.864.864,0,0,0,.451.451.818.818,0,0,0,.32.066H16.509a.826.826,0,0,0,0-1.651H7.5L9.332,6.406a.827.827,0,0,0,0-1.167A.818.818,0,0,0,8.749,5Z", fill:"#53f3c3" }))); };
var MenuTradingIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 25.973 25.973" }, props),
    React.createElement("path", { d: "M7.034,14.069A7.034,7.034,0,0,1,7.034,0c.184,0,.379.011.563.022a7.044,7.044,0,0,1,6.45,6.45c.011.184.022.379.022.563A7.034,7.034,0,0,1,7.034,14.069Z", transform:"translate(2.165 9.74)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M8.008,13.982v-.065A8.727,8.727,0,0,0,.032,5.974H0a7.031,7.031,0,1,1,8.008,8.008Z", transform:"translate(9.827 2.164)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M1.082,0A1.085,1.085,0,0,0,0,1.082v2.8a1.085,1.085,0,0,0,1.851.768l2.8-2.8A1.088,1.088,0,0,0,3.885,0Z", transform:"translate(2.165 2.164)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M3.885,4.972A1.085,1.085,0,0,0,4.967,3.89v-2.8A1.085,1.085,0,0,0,3.116.318l-2.8,2.8a1.088,1.088,0,0,0,.768,1.851Z", transform:"translate(18.842 18.837)", fill:"#53f3c3" }))); };
var MenuLiquidityIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 22.604 29.038" }, props),
    React.createElement("path", { d: "M11.075,0h.452a1.145,1.145,0,0,1,.832.547q2.006,2.822,4.021,5.644,2.384,3.354,4.779,6.7a8.075,8.075,0,0,1,.972,2.095,9.554,9.554,0,0,1,.476,3.114,10.124,10.124,0,0,1-.619,3.517,11.125,11.125,0,0,1-1.679,3.027,11.581,11.581,0,0,1-3.5,3.031,10.239,10.239,0,0,1-3.382,1.234,14.648,14.648,0,0,1-2.847.113,8.982,8.982,0,0,1-2.29-.308A12.037,12.037,0,0,1,4.6,26.9a11.452,11.452,0,0,1-3.578-4.3,9.98,9.98,0,0,1-.952-3.272,10.36,10.36,0,0,1,.636-5.047,11.157,11.157,0,0,1,1.4-2.345C3.206,10.421,4.283,8.9,5.37,7.38,6.856,5.3,8.335,3.221,9.825,1.148c.132-.184.276-.361.39-.555A1.067,1.067,0,0,1,11.075,0Z", transform:"translate(-0.003)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M126.987,213.606a1.03,1.03,0,0,1-1.081-.442,1.012,1.012,0,0,1,.674-1.554c.4-.075.8-.05,1.2-.15a4.417,4.417,0,0,0,3.333-3.661c.035-.241.035-.491.066-.73a.967.967,0,0,1,1.156-.883,1.015,1.015,0,0,1,.875,1.076,6.533,6.533,0,0,1-1.006,3.343,6.391,6.391,0,0,1-4.46,2.945A3.346,3.346,0,0,1,126.987,213.606Z", transform:"translate(-115.453 -189.311)", fill:"#273043" }))); };
var MenuPoolsIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24.235 19.574" }, props),
    React.createElement("path", { d: "M0,286.949c1.072,0,2.144,0,3.216,0a.339.339,0,0,1,.326.166,3,3,0,0,0,1.907,1.258H0Z", transform:"translate(0 -268.798)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M34.351,85.523H27.64a2.9,2.9,0,0,0-4.153-2.2c-.167-.678-.33-1.341-.492-2-.322-1.318-.649-2.635-.959-3.956-.049-.21-.142-.254-.336-.249-.511.012-1.023,0-1.553,0V73.876H41.841v3.238h-.575c-.331,0-.663.013-.994,0-.195-.01-.271.052-.317.243-.393,1.642-.8,3.281-1.2,4.922-.084.344-.169.687-.257,1.044a2.9,2.9,0,0,0-4.15,2.206", transform:"translate(-18.874 -69.203)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M141.514,3.219c0-.783,0-1.541.006-2.3a.252.252,0,0,1,.132-.18c.534-.231,1.073-.453,1.613-.671a.945.945,0,0,1,.252-.041,5.325,5.325,0,0,1,3,.591,1.108,1.108,0,0,1,.68.745c.17.62.4,1.222.618,1.854Z", transform:"translate(-132.563 0)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M100.8,288.323a3.133,3.133,0,0,0,1.454-.737,1.62,1.62,0,0,0,.348-.384.582.582,0,0,1,.617-.3c2.264.01,4.527.008,6.791,0a.419.419,0,0,1,.406.2,2.8,2.8,0,0,0,1.77,1.172c.031.007.062.01.092.018,0,0,.007.013.014.029Z", transform:"translate(-94.426 -268.756)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M255.395,3.655c-.8,0-1.6,0-2.393,0-.282,0-.63.082-.825-.052s-.212-.487-.3-.747c-.2-.581-.394-1.163-.6-1.77.457-.151.914-.269,1.345-.452a4.373,4.373,0,0,1,1.746-.179.193.193,0,0,1,.143.108c.3,1,.6,2.008.9,3.013,0,.013,0,.029-.014.08", transform:"translate(-235.383 -0.42)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M63.815,14.384c0-.459,0-.9.006-1.341a.294.294,0,0,1,.125-.179q.587-.441,1.184-.867a.385.385,0,0,1,.235-.074c.612.056,1.224.123,1.835.187a.568.568,0,0,1,.095.028c0,.051.013.1.013.142,0,.695,0,1.39,0,2.1Z", transform:"translate(-59.777 -11.168)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M71.87,241.036a1.453,1.453,0,0,1,0,2.905,1.453,1.453,0,1,1,0-2.905", transform:"translate(-65.959 -225.79)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M268.357,241.037a1.453,1.453,0,1,1-1.446,1.444,1.45,1.45,0,0,1,1.446-1.444", transform:"translate(-250.029 -225.791)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M301.518,287v1.4h-5.512a2.959,2.959,0,0,0,2.035-1.312.211.211,0,0,1,.147-.087c1.1-.005,2.205,0,3.331,0", transform:"translate(-277.284 -268.849)", fill:"#53f3c3" }))); };
var MenuFarmsIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24.235 20.58" }, props),
    React.createElement("path", { d: "M340.034,259.018c-.092.357-.157.724-.282,1.069a4.246,4.246,0,1,1,.235-2.1,1.705,1.705,0,0,0,.047.181Zm-3.552-.437a.708.708,0,1,0-.7.719.715.715,0,0,0,.7-.719", transform:"translate(-315.8 -242.278)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M5.685,194.289A5.679,5.679,0,1,1,0,199.957a5.692,5.692,0,0,1,5.684-5.668m.007,7.808a2.128,2.128,0,1,0-2.14-2.111,2.148,2.148,0,0,0,2.14,2.111", transform:"translate(0 -185.074)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M5.983,137.465l-.913-1.1c.437-.287.846-.592,1.289-.838a8.4,8.4,0,0,1,5.433-.99,7.96,7.96,0,0,1,3.067,1.109,1.383,1.383,0,0,0,.773.215q4.555-.011,9.11,0a2.835,2.835,0,0,1,2.833,2.223,2.156,2.156,0,0,1,.061.42c.009.306,0,.612,0,.924-.379-.156-.738-.334-1.116-.454a5.607,5.607,0,0,0-6.428,2.268.573.573,0,0,1-.565.3c-.677-.021-1.356-.007-2.046-.007a7.015,7.015,0,0,0-4.6-5.256,6.991,6.991,0,0,0-6.894,1.187", transform:"translate(-4.83 -128.06)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M56.633,0V1.4H55.411l1.3,4.958c-.1.005-.171.012-.245.012-.773,0-1.546.005-2.318,0a.812.812,0,0,1-.376-.1,9.824,9.824,0,0,0-5.322-1.3c-.572.022-1.142.117-1.737.182V1.413H45.3V0Z", transform:"translate(-43.154)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M362.664,49.194h-1.42c0-.313,0-.618,0-.923.01-.52-.01-1.044.046-1.559a2.071,2.071,0,0,1,2.071-1.75v1.314c-.2.141-.443.229-.55.4a1.394,1.394,0,0,0-.142.672c-.018.606-.006,1.213-.006,1.845", transform:"translate(-344.109 -42.829)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M271.336,314.431l-.134,2.1h-1.486v-2.1Z", transform:"translate(-256.923 -299.518)", fill:"#53f3c3" }),
    React.createElement("path", { d: "M105.521,300.523a.708.708,0,1,1,.713-.7.715.715,0,0,1-.713.7", transform:"translate(-99.846 -284.921)", fill:"#53f3c3" }))); };
var MenuDocumentIcon = function(props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 22 28.881" }, props),
    React.createElement("path", { d: "M2.2,0H13.539q0,2.848,0,5.7a2.555,2.555,0,0,0,2.779,2.765H22v.307q0,8.727,0,17.455a2.538,2.538,0,0,1-2.66,2.657q-8.333,0-16.665,0a2.975,2.975,0,0,1-.477-.027A2.529,2.529,0,0,1,0,26.234Q0,17.577,0,8.92,0,5.748,0,2.576A2.408,2.408,0,0,1,1.121.452,6.224,6.224,0,0,1,2.2,0M11.01,13.594q2.494,0,4.987,0a.849.849,0,1,0-.005-1.692q-3.522,0-7.044,0c-.986,0-1.972,0-2.958,0a.848.848,0,1,0,.005,1.692q2.508.005,5.015,0M11,15.286q-2.494,0-4.987,0a.856.856,0,0,0-.859.518A.846.846,0,0,0,6,16.978q3.3,0,6.593,0,1.7,0,3.409,0a.848.848,0,1,0,0-1.692q-2.508-.005-5.015,0m0,5.077q2.494,0,4.987,0a.857.857,0,0,0,.85-.488.839.839,0,0,0-.805-1.2c-1.615-.005-3.231,0-4.846,0q-2.592,0-5.184,0a.851.851,0,0,0-.829.475.842.842,0,0,0,.813,1.217c1.672,0,3.344,0,5.015,0M9.313,22.055q-1.648,0-3.3,0a.85.85,0,1,0,0,1.691q3.281,0,6.563,0a.852.852,0,1,0,0-1.691q-1.634,0-3.267,0", fill:"#53f3c3" }),
    React.createElement("path", { d: "M202.115,7.367l6.2,6.2c-.066,0-.135.013-.2.013q-2.521,0-5.043,0a.862.862,0,0,1-.956-.958q0-2.521,0-5.043Z", transform:"translate(-186.884 -6.812)", fill:"#53f3c3" }))); };
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    Svg: Svg,
    MenuHomeIcon: MenuHomeIcon,
    MenuExchangeIcon: MenuExchangeIcon,
    MenuTradingIcon: MenuTradingIcon,
    MenuLiquidityIcon: MenuLiquidityIcon,
    MenuPoolsIcon: MenuPoolsIcon,
    MenuFarmsIcon: MenuFarmsIcon,
    MenuDocumentIcon: MenuDocumentIcon
});
...
var ButtonMenu$1 = function (_a) {
    ...
    return (React__default.createElement(StyledButtonMenu, __assign({ disabled: disabled, variant: variant, fullWidth: fullWidth }, props), Children.map(children, function (child, index) {
        return cloneElement(child, {
            ...
            scale: scale,
            variant: activeIndex === index?"primary":variant,
            disabled: disabled,
        });
    })));
};
...
var InactiveButton = styled(Button)(templateObject_1$Z || (templateObject_1$Z = __makeTemplateObject(["\n  background-color: #36425A;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: #36425A;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return (variant === variants$6.PRIMARY ? theme.colors.textSubtle : theme.colors.textSubtle);
});
...
var CakePrice = function (_a) {
    ...
    return React__default.createElement(PriceLink, { href: "https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank", isMobile:isMobile },
        React__default.createElement(Icon$13, { width: "42px", mr: "8px" }),
        cakePriceUsd ? (React__default.createElement(Text, { color: color, bold: true }, "$" + cakePriceUsd.toFixed(3))) : (React__default.createElement(Skeleton, { width: 80, height: 24 })));
};
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#1EBF8D", background: "#1A202C", backgroundDisabled: "#36425A", backgroundAlt: "#131722", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#36425A", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#FFFFFF", disabled: "#524B63", gradients: {
...
var getBaseThumbStyles = function (_a) {
    ...
    return "\n  -webkit-appearance: none;\n  background-color: #1EBF8D;\n  border: 2px solid white;\n border-radius:8px;\n  cursor: " + getCursorStyle + ";\n  width: 16px;\n  height: 16px;\n  filter: " + (disabled ? "grayscale(100%)" : "none") + ";\n transform: translate(-2px,2px);  transition: 200ms transform;\n\n  &:hover {\n " + (disabled ? "" : "opacity: 0.8") + ";\n  }\n";
};
...
var Slider = function (_a) {
    ...
    var labelProgress = isMax ? "100%" : progressPercentage + "%";
...
var Icon$1 = function (props) {
    return React__default.createElement('img', __assign({ src:"/images/hourglass.png" }, props));
...
var MenuItem$1 = function (_a) {
    ...
    return (React__default.createElement(StyledMenuItemContainer, { "$isActive": isActive, "$variant": variant },
        href==="https://docs.godex.exchange" ? (React__default.createElement(StyledMenuItem, __assign({ as: Link, href: href, external: true   }, props), children)) : (React__default.createElement(StyledMenuItem, __assign({ as: Link$1, to: href, "$isActive": isActive, "$variant": variant, "$statusColor": statusColor }, props), children))));
};
    ...
    return (React__default.createElement(Wrapper$1, { p: ["0 4px", "0 16px"] },
        React__default.createElement(Inner$1, null, Children.map(children, function (child, index) {
            ...
            return cloneElement(child, {
                ...
                onClick: onItemClick ? function () { return onItemClick(index); } : undefined,
                color: "textSubtle",
                backgroundColor: isActive ? "primary" : "input",
            });
        }))));
};
...
return (React__default.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog", style:{
    border: '2px solid white',borderRadius: '50%',width: '25px',height: '25px'} },
        React__default.createElement(Icon$1H, { color: "white" })));
};
...
var Modal = function (_a) {
    ...
    return (React__default.createElement(ModalContainer, __assign({ minWidth: minWidth }, props),
        title===null?null:React__default.createElement(ModalHeader, { background: getThemeValue("colors." + headerBackground, headerBackground)(theme) },
...
var AnimatedIconComponent = function (_a) {
    ...
    return IconElement ? (React__default.createElement(StyledAnimatedIconComponent, __assign({ isActive: isActive, hasFillIcon: hasFillIcon }, props),
        React__default.createElement(StyledIconContainer, { activeBackgroundColor: activeBackgroundColor },
            React__default.createElement(IconElement, { fill: "#1EBF8D", width: "100%", height: "100%" , style:{fill:"rgb(83, 243, 195)"}})),
...
var BottomNavItem = function (_a) {
    ...
    var bottomNavItemContent = (React__default.createElement(Flex, { alignItems:"center" },
        iconName && (React__default.createElement(AnimatedIconComponent, { iconName: iconName, height: "32px", width: "32px",  color: isActive ? "secondary" : "textSubtle", isActive: isActive, activeBackgroundColor: "none", style:{marginRight: "10px"} })),
        React__default.createElement(StyledBottomNavText, { color: isActive ? "text" : "textSubtle", fontWeight: isActive ? "600" : "400", fontSize: "16px" }, label)));
    return showItemsOnMobile ? (React__default.createElement(StyledBottomNavItem, __assign({ as: Link, href: href, external: true   }, props), bottomNavItemContent)) : (React__default.createElement(StyledBottomNavItem, __assign({ as: Link$1, to: href }, props), bottomNavItemContent));
};

var StyledBottomNav = styled(Flex)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  position: fixed;\n  height: 100vh;\n  left: 0px; top: 0px; flex-direction: column; z-index:99; align-items: start; width: auto;\n  padding: 0;\n  background: ", ";\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n"], ["\n  position: fixed;\n  height: 100vh;\n left: 0px; top: 0px; flex-direction: column; z-index:99; align-items: start;  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n"])), function (_a) {
    return "#273043";
});
var templateObject_1$c;
...
var DropdownMenu = function (_a) {
    ...
    return (React__default.createElement(Box, __assign({ ref: isBottomNav ? null : setTargetRef }, props),
        ...
        // isBottomNav && isOpen && false && React__default.createElement(StyledOverlay, null),
...
var SidebarHeader = function(_a) {
    return React__default.createElement(Flex, { justifyContent:"space-between", alignItems:"center", p:"20px" },
        React__default.createElement(Text, { fontSize:"20px", color:"white" },"Menu"),
        React__default.createElement(Box, { mx: "12px" },
            React__default.createElement(CakePrice$1, { cakePriceUsd: _a.cakePriceUsd, isSidebar: true })),
        React__default.createElement(Button, { variant:"text", onClick:_a.onDismiss },
            React__default.createElement(Svg, { viewBox:"0 0 20.764 20.238" },
                React__default.createElement('path', { d:"M8.828,4,9.857,2.974a1.108,1.108,0,0,1,1.571,0l9.009,9a1.108,1.108,0,0,1,0,1.571l-9.009,9.009a1.108,1.108,0,0,1-1.571,0L8.828,21.53a1.113,1.113,0,0,1,.019-1.59l5.584-5.32H1.112A1.11,1.11,0,0,1,0,13.508V12.025a1.11,1.11,0,0,1,1.112-1.112H14.431L8.847,5.592A1.105,1.105,0,0,1,8.828,4Z", transform:"translate(20.764 22.886) rotate(180)", fill:"#fff" })
            )
        )
    );
}
...
var BottomNav = function (_a) {
    var _b = _a.items, items = _b === void 0 ? [] : _b, _c = _a.activeItem, activeItem = _c === void 0 ? "" : _c, _d = _a.activeSubItem, activeSubItem = _d === void 0 ? "" : _d, props = __rest(_a, ["items", "activeItem", "activeSubItem"]), cakePriceUsd = _a.cakePriceUsd;
    return (React__default.createElement(StyledBottomNav, __assign({ justifyContent: "flex-start" }, props), 
        React__default.createElement(SidebarHeader,{ cakePriceUsd, onDismiss:_a.onDismiss }),
        items.map(function (_a) {
            ...
            return (showOnMobile && (React__default.createElement(DropdownMenu, { key: label, items: menuItems, isBottomNav: true, activeItem: activeSubItem, showItemsOnMobile: showItemsOnMobile, style:{width:'100%'} },
                React__default.createElement(Box, { style:{borderLeft:(href === activeItem?"5px solid #53F3C3":"5px solid transparent"),background:(href === activeItem?"linear-gradient(90deg, #38435A, transparent)":"none")} },
        ...
        socials.map(function (_a) {
            var label = _a.label, menuItems = _a.items, href = _a.href, icon = _a.icon, _b = _a.showOnMobile, showOnMobile = _b === void 0 ? true : _b, _c = _a.showItemsOnMobile, showItemsOnMobile = _c === void 0 ? true : _c;
            return (showOnMobile && (React__default.createElement(DropdownMenu, { key: label, isBottomNav: true, activeItem: activeSubItem, showItemsOnMobile: showItemsOnMobile, style:{width:'100%'} },
                React__default.createElement(Box, { style:{borderLeft:(href === activeItem?"5px solid #53F3C3":"5px solid transparent"),background:(href === activeItem?"linear-gradient(90deg, #38435A, transparent)":"none")} },
                    React__default.createElement(BottomNavItem, { href: href, isActive: href === activeItem, label: label, iconName: icon, showItemsOnMobile: showItemsOnMobile })))));
        }),
    ));
...
var socials = [
    {
        label: "Reddit",
        icon: "Reddit",
        href: "https://www.reddit.com/user/godextoken",
    },
    {
        label: "Telegram",
        icon: "Telegram",
    ...
    },
    {
        label: "Twitter",
        icon: "Twitter",
        href: "https://twitter.com/godextoken",
    },
    {
        label: "Medium",
        icon: "Instagram",
        href: "https://medium.com/@godextoken",
    },
    {
        label: "Github",
        icon: "Github",
...
const ContactBox = React__default.createElement('div',{ style: { padding: '20px', background: '#1F2533', borderRadius: '10px', color: '#8B95A8', marginTop: '40px', fontFamily: 'Poppins', width: '350px'}}, 
    ...
    React__default.createElement(Flex, { flexDirection: "row", style:{borderBottom: '1px solid #4a5568'} },
        React__default.createElement(Svg,{ width:21, height:16, viewBox:'0 0 21 16' },
            React__default.createElement('path',{d:'M4.846,6H19.61a1.851,1.851,0,0,1,1.846,1.846V18.919a1.851,1.851,0,0,1-1.846,1.846H4.846A1.851,1.851,0,0,1,3,18.919V7.846A1.851,1.851,0,0,1,4.846,6Z',fill:'none',stroke:'#8b95a8',transform:'translate(-1.816 -5.15)'}),
            React__default.createElement('path',{d:'M21.455,9l-9.228,6.459L3,9',fill:'none',stroke:'#8b95a8',transform:'translate(-1.816 -5.15)'})
        ),
        React__default.createElement('input', {id:'input-email',placeholder:'Enter your email',style:{position: 'unset',opacity: 1,background: 'none',border: 'none',outline: 'none',color: 'white',padding: '5px',flex:1}}),
        React__default.createElement(Button, {style:{background: 'none',padding: 0,color: '#4a5568'}}, "Submit")
    )
);
var MenuItem = function (_a) {
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default.createElement(StyledIconMobileContainer, { display: ["none", null, "none"] },
            ...
            React__default.createElement(Flex, { order: [2, null, 1], flexDirection: ["column", null, "row"], justifyContent: "space-between", alignItems: "flex-start", mb: ["42px", null, "36px"] }, 
                React__default.createElement(Box, { display: ["block", null, "block"] },
                    React__default.createElement(LogoWithTextIcon, { isDark: true, width: "255px" }),
                    React__default.createElement('p', { style: {
                        maxWidth: '270px', fontSize: '16px', color: '#8B95A8', fontFamily: 'Poppins', paddingTop: '20px', lineHeight: '1.2em'
                    }}, "GoDex Stable, Secure And Secure Decentralized Exchange"), ContactBox),
            React__default.createElement(Flex, {flexDirection: "column", justifyContent: "space-between", alignItems: "flex-start", flex: 1, height:"100%", p:"20px 10px" }, 
                React__default.createElement(Flex, {flexDirection: ["column", null, "row"], justifyContent: "space-between", alignItems: "flex-start", width:"100%" }, 
                    ...
                    items.map(function (item) {
                        ...
                        return (React__default.createElement(StyledList, { key: item.label },
                            ...
                            _a.map(function (_a) {
                                ...
                                return (React__default.createElement(StyledListItem, { key: label, order: [2, null, 1], }, 
                                    React__default.createElement(Link, { href: href, target: "_blank", rel: "noreferrer noopener", color: isHighlighted ? baseColors.warning : "#8B95A8", bold: false }, label)));
                            })));
                    })
                ),
                React__default.createElement(StyledSocialLinks, { order: [2]/*, pb: ["42px", null, "32px"], mb: ["0", null, "32px"]*/ })
            )),
        React__default.createElement('div',{style:{color:'#8B95A8',fontSize:['15px','20px','25px'],order: 3,textAlign: 'center',letterSpacing: '0.3em'}},"GoDex Exchange 2021 Copyright"))))
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Icon$1m, { className: "mobile-icon", width: "23.4vw" }),
        React__default.createElement(LogoWithTextIcon, { className: "desktop-icon", isDark: isDark })));
    return (React__default.createElement(Flex, null, isAbsoluteUrl ? (React__default.createElement(StyledLink, { as: "a", href: href, "aria-label": "GoDex home page" }, innerLogo)) : (React__default.createElement(StyledLink, { to: href, "aria-label": "GoDex home page" }, innerLogo))));
};
    ...
    return (React__default.createElement(Wrapper, null,
        React__default.createElement(StyledNav, { showMenu: showMenu },
            React__default.createElement(Flex, null,
                isMobile && React__default.createElement(Box, {onClick: function() { setShowSidebar(true) }},
                    React__default.createElement(BarsIcon, { isDark: isDark, width: "7.5vw", mr: "10px"}),
                ),
                ...
                !isMobile && React__default.createElement(MenuItems, { items: links, activeItem: activeItem, activeSubItem: activeSubItem, ml: "43px" })),
            React__default.createElement(Flex, { alignItems: "center" },
        ...
        React__default.createElement(BodyWrapper, { mt: !subLinks ? (isMobile?MOBILE_MENU_HEIGHT:MENU_HEIGHT) + 1 + "px" : "0" },
        ...
        isMobile && showSidebar && React__default.createElement(Overlay, {show: true, onClick: function() { setShowSidebar(false) }}),
        isMobile && showSidebar && React__default.createElement(BottomNav, { items: links, activeItem: activeItem, activeSubItem: activeSubItem, cakePriceUsd: cakePriceUsd, onDismiss: function() { setShowSidebar(false) }})));
};
...
var StyledConnectWrapper = styled.div({
    background: '#273043',
    borderRadius: '25px',
    display: 'flex',
    color: 'white',
...
var UserMenu = function (_a) {
    ...
    return (React__default.createElement(StyledConnectWrapper, null,
        !isMobile && React__default.createElement('span',null,React__default.createElement('span'),'BSC'),
        React__default.createElement(StyledUserMenu, __assign({ ref: setTargetRef, isMobile: isMobile }, props),
            React__default.createElement(LabelText, { title: text || account }, text || accountEllipsis),
            React__default.createElement(Icon$1G, { color: "text", width: "24px" })),
...
var WalletButton = styled(Button).attrs({ width: "100%", variant: "text", py: "16px", justifyContent: "flex-start", mb: "15px" })(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  align-items: center;\n  display: flex;\n  flex-direction: row;\n  height: auto;\n  justify-content: flex-start;\n background: #273043;  margin-left: auto;\n  margin-right: auto;\n"], ["\n  align-items: center;\n  display: flex;\n  flex-direction: column;\n  height: auto;\n  justify-content: flex-start;\n background: #273043; margin-left: auto;\n  margin-right: auto;\n"])));
...
var WalletCard = function (_a) {
    ...
    return (React__default.createElement(WalletButton, { variant: "tertiary", onClick: function () {
        ...
        React__default.createElement(Text, { fontSize: "1.5em", pl: "1em" }, title)));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        React__default.createElement(ModalHeader, { background: "#1F2533" },
            React__default.createElement(ModalTitle, null,
                React__default.createElement(Heading, {scale:'lg'}, t("Connect Wallet"))),
            React__default.createElement(ModalCloseButton, { onDismiss: onDismiss })),
        React__default.createElement(ModalBody, { background: "#1F2533", width: ["320px", null, "340px"] },
            React__default.createElement(WalletWrapper, { px: "20px", pt: "24px", pb: "10px", maxHeight: "453px", overflowY: "auto" },
