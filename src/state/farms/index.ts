...
export const fetchFarmUserDataAsync = createAsyncThunk<FarmUserDataResponse[], { account: string; pids: number[] }>(
  ...
  async ({ account, pids }) => {
    ...
    const userCanHarvest = await fetchFarmUserCanHarvest(account, farmsToFetch)
...
export const farmsSlice = createSlice({
  ...
  reducers: {
    ...
    //     const userPoolData = userData.find((entry) => entry.pid === farm.pid)
    //     return { ...farm, userData: userPoolData }
    //   })
...
// Actions
// export const { setLoadArchivedFarmsData, setFarmsUserData } = farmsSlice.actions
