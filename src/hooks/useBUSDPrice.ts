...
// const { busd: BUSD_MAINNET } = tokens
...
export default function useBUSDPrice(currency?: Currency): Price | undefined {
  ...
  // console.log('ethPairState', busdEthPairState)
  // console.log('busdPairState', busdPairState)
  // console.log('busdEthPairState', busdEthPairState)
  return useMemo(() => {
